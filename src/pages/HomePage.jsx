...
export function HomePage() {
  ...
  const filteredBrands = useMemo(() => {
    ...
    const vehicleTypeBrands = {
      ...
      'motor': ['Aeon', 'AJP', 'AJS', 'Apollo Motors', 'Aprilia', 'Asiawing', 'Barton', 'Bashan', 'Benda', 'Benelli', 'Beta', 'Bimota', 'BMW', 'Brixton', 'BRUT-X', 'Bucci Moto', 'Buell', 'Cagiva', 'Can-Am', 'CF Moto', 'CPI', 'Custom', 'ČZ', 'Daelim', 'Derbi', 'Dnepr', 'DKW', 'Dream Pitbikes', 'Ducati', 'Ebroh', 'E Ride', 'EM', 'Energica', 'Enfield', 'Fantic', 'FB Mondial', 'FYM', 'Garelli', 'Generic', 'GasGas', 'Giantco', 'Gilera', 'GunShot', 'Harley-Davidson', 'Hengjian', 'HM Moto', 'Honda', 'Horwin', 'Husaberg', 'Husqvarna', 'Hyosung', 'Indian', 'Italjet', 'Jawa', 'Jiajue', 'Jinlun', 'Junak', 'K-Sport', 'Kangchao', 'Kawasaki', 'Kayo', 'KeeWay', 'Kinroad', 'KL Motors', 'Kove', 'Kreidler', 'KSR Moto', 'KTM', 'Kuberg', 'Kymco', 'Laverda', 'LEM', 'Leonart', 'Longjia', 'Mac Motorcycles', 'Macbor', 'Maico', 'Malaguti', 'Marshal', 'Mash', 'Mecatecno', 'Morbidelli', 'Motobi', 'Montesa', 'MotoGuzzi', 'Moto Morini', 'Motor Union', 'Motowell', 'Motron', 'MV Agusta', 'MZ', 'Norton', 'NSU', 'Ohvale', 'Oldtimer', 'Oset', 'Palmo', 'Peugeot', 'Phelon & Moore', 'Pioneer', 'Pitbikes', 'Pitsterpro', 'Polaris', 'Puch', 'Qingqi', 'QJMotor', 'Qulbix', 'Regal Raptor', 'Rieju', 'Romet', 'Royal Enfield', 'Sachs', 'Sarolea', 'SCZ', 'Sherco', 'Shineray', 'SiaMoto', 'Skygo', 'Skyteam', 'Stallions', 'Stark', 'Stomp', 'Super soco', 'Surron', 'Suzuki', 'SWM', 'Sym', 'Talaria', 'Thumpstar', 'Tinbot', 'TM Racing', 'TMS', 'Tomos', 'Torrot', 'Trike', 'Triton', 'Triumph', 'Tromox', 'TRS', 'UM', 'Ural', 'Urbet', 'Velocifero', 'Vent', 'Victory', 'Vins', 'Voge', 'VOR', 'Wottan Motor', 'Xingyue', 'Xinling', 'Xmotos', 'Yamaha', 'YCF', 'Yiying', 'Zero', 'Zongshen', 'Zontes', 'Zhongyu', 'Ztech', 'Zundapp', 'MOTO'],
